...
import ReverseTabnabber from './ReverseTabnabber';
...
const NavBar = (): JSX.Element => {
  ...
  return(
    ...
    text-3xl bg-white text-white shadow-lg">
      <button className="ml-4 my-2 px-2 hover:bg-gray-200 rounded-md" onClick={() => toggleButton()}>
      ...
      h-10 w-10 bg-slate-100 rounded-full justify-center px-1">
